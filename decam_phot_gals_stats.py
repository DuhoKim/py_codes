...
for k in range(0, len(clusters)):
    fh = open(sex_dir+'DECam_19_21_aug_2014_multi_exp_SEx_cat_'+clusters[k]+'_match_rad_1as_'
                                    'Gal_ext_corrected_Min_as_mag.txt', 'w')
    ...
    fh.writelines('#   7 MAG_ISO_u              Isophotal magnitude in u-band (median)                     [mag] \n')
    fh.writelines('#   8 MAGERR_ISO_u           stddev for isophotal magnitude (0.5 for sole sample)       [mag] \n')
    fh.writelines('#   9 NUM_OF_EXP_u           Total number of matched u-band exposures \n')
    fh.writelines('#  10 TOTAL_EXP_TIME_u       Total time of matched u-band exposures                     [sec] \n')
    fh.writelines('#  11 MAG_ISO_g              Isophotal magnitude in g-band (median)                     [mag] \n')
    fh.writelines('#  12 MAGERR_ISO_g           1-sigma error for isophotal magnitude                      [mag] \n')
    fh.writelines('#  13 NUM_OF_EXP_g           Total number of matched g-band exposures \n')
    fh.writelines('#  14 TOTAL_EXP_TIME_g       Total time of matched g-band exposures                     [sec] \n')
    fh.writelines('#  15 MAG_ISO_r              Isophotal magnitude in r-band (median)                     [mag] \n')
    fh.writelines('#  16 MAGERR_ISO_r           1-sigma error for isophotal magnitude                      [mag] \n')
    fh.writelines('#  17 NUM_OF_EXP_r           Total number of matched r-band exposures \n')
    fh.writelines('#  18 TOTAL_EXP_TIME_r       Total time of matched r-band exposures                     [sec] \n')
