...
for m in range(0, len(dates)):
    ...
    if m == 0:
        ...
        excl_num = [[], [], [4929], [8153, 2152, 5995]]


        a_guess = 0.4244 + np.linspace(-0.0001, 0.0001, 11)
        b_guess = -0.2086 + np.linspace(-0.0001, 0.0001, 11)
        ...
        a_guess = 0.4173 + np.linspace(-0.0001, 0.0001, 11)
        b_guess = -0.1745 + np.linspace(-0.0001, 0.0001, 11)
        ...
        a_guess = 0.2787 + np.linspace(-0.0001, 0.0001, 11)
        b_guess = -0.0792 + np.linspace(-0.0001, 0.0001, 11)
