...
for m in range(2, len(dates)):
    ...
    if m == 0:
        ...
        a_guess = 0.381 + np.linspace(-0.1, 0.1, 100)
        b_guess = -0.186 + np.linspace(-0.1, 0.1, 100)
        ...
        a_guess = 0.361 + np.linspace(-0.01, 0.01, 1000)
        b_guess = -0.163 + np.linspace(-0.01, 0.01, 1000)
        ...
        a_guess = 0.180 + np.linspace(-0.01, 0.01, 1000)
        b_guess = -0.036 + np.linspace(-0.01, 0.01, 1000)
    ...
    plt.savefig(plot_dir+ss_date+'_DECam_'+band+'_band_standardized_vs_trimmed_aper_corr7.pdf')
