...
for m in range(0, len(dates)):
    ...
    if m == 0:
        ...
        a_guess = 0.567 + np.linspace(-0.01, 0.01, 1000)
        b_guess = -0.136 + np.linspace(-0.01, 0.01, 1000)
        ...
        a_guess = 0.411 + np.linspace(-0.005, 0.005, 1000)
        b_guess = -0.047 + np.linspace(-0.005, 0.005, 1000)
        ...
        a_guess = 0.492 + np.linspace(-0.01, 0.01, 1000)
        b_guess = -0.078 + np.linspace(-0.01, 0.01, 1000)
    ...
    plt.savefig(plot_dir+ss_date+'_DECam_'+band+'_band_standardized_vs_trimmed_aper_corr5.pdf')
