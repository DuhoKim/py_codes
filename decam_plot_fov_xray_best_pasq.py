...
def a_pas(p):
    return 0.022 * p ** 3 - 0.512 * p ** 2 + 3.287 * p - 2.786

def b_pas(p):
    return 0.184 * p ** 2 - 1.494 * p - 3.5

def c_pas(p):
    return -0.108 * p ** 2 + 1.249 * p + 0.314

def phase_region2(x, y):    # Pasquali+19
    y = abs(y)
    for p in range(1, 8):
        if y < a_pas(p) * x ** 2 + b_pas(p) * x + c_pas(p):
            return p - 1
    return 7

def draw_phase_region2(draw_ax, draw_alpha):
    xxx = np.linspace(0, 3, 100)
    yyy = np.zeros(100)
    for p in range(1, 8):
        for i in range(len(xxx)):
            yyy[i] = a_pas(p) * xxx[i] ** 2 + b_pas(p) * xxx[i] + c_pas(p)
        draw_ax.plot(xxx, yyy, ls='--', c='black', alpha=draw_alpha)
...
fig134, axs134 = plt.subplots(tight_layout=True, figsize=(6, 6))
...
# 2D array for number counts of galaxies in each region2 in a phase-space for each feature type
ncnt_reg2 = np.array([
    [0, 0, 0, 0, 0, 0, 0, 0],     # no feat
    [0, 0, 0, 0, 0, 0, 0, 0],     # PM
    [0, 0, 0, 0, 0, 0, 0, 0]     # I
])

# same as above but for galaxies selected by at least 3 people not 2 people
ncnt_reg2_3 = np.array([
    [0, 0, 0, 0, 0, 0, 0, 0],     # no feat
    [0, 0, 0, 0, 0, 0, 0, 0],     # PM
    [0, 0, 0, 0, 0, 0, 0, 0]     # I
])
...
#    for plim_p in plim_ps:
    ...
    if (k == 3 or k == 6):
        ...
        ncnt_else2 = np.array([0, 0, 0])  # no feat, PM, I
        ...
        ncnt_else2_3 = np.array([0, 0, 0])  # no feat, PM, I
    else:
        ncnt_this = np.array([
            [0, 0, 0, 0, 0, 0],  # no feat
            [0, 0, 0, 0, 0, 0],  # PM
    ...
    if k == 3:
        ...
        ax1_in_ds = ax1_ds.inset_axes([0.7, 0.05, 0.25, 0.25])
                ...
                if res_cat['col2'][ind] == 0:  # classified as no feature
                    ...
                    if k == 3:      # subgroup 2 and 5 for a3558
                        if (r_cat[i] == 2):     # Green component in 7th BIC
                            ...
                            ncnt_reg2[0, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ncnt_reg2_3[0, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ncnt2_58[0, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ncnt2_58_3[0, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ...
                            ncnt_reg2[0, phase_region(r_in_r200_62[i], delv62)] += 1
                            ncnt_reg2_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62[0, phase_region(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                            if dsp_alloc[i] < 0:
                                incre_cnt_dsp(0, -1, 2)
                            else:
                        ...
                        if (r_cat[i] == 1):     # Orange component in 1st BIC   S
                            ...
                            ncnt_reg2[0, phase_region2(r_in_r200_62[i], delv62)] += 1
                            ncnt_reg2_3[0, phase_region2(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62[0, phase_region2(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62_3[0, phase_region2(r_in_r200_62[i], delv62)] += 1
                        else:
                            ncnt_else[0] += 1
                            ncnt_else_3[0] += 1
                        ...
                        ncnt_reg2[0, phase_region2(r_in_r200[i], delv)] += 1
                        ncnt_reg2_3[0, phase_region2(r_in_r200[i], delv)] += 1
                        ncnt_this2[0, phase_region2(r_in_r200[i], delv)] += 1
                        ncnt_this2_3[0, phase_region2(r_in_r200[i], delv)] += 1
                        incre_cnt_dsp(0, dsp_alloc[i], 2)
                    ...
                    if k == 3:
                        if (r_cat[i] == 2):
                            ...
                            ncnt_reg2[1, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ncnt2_58[1, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ...
                            if res_cat['col3'][ind] > 2:
                                ...
                                ncnt_reg2_3[1, phase_region2(r_in_r200_58[i], delv58)] += 1
                                ncnt2_58_3[1, phase_region2(r_in_r200_58[i], delv58)] += 1
                            else:
                                ncnt_reg_3[0, phase_region(r_in_r200_58[i], delv58)] += 1
                                ncnt_58_3[0, phase_region(r_in_r200_58[i], delv58)] += 1
                            ...
                            ncnt_reg2[1, phase_region2(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62[1, phase_region2(r_in_r200_62[i], delv62)] += 1
                            if dsp_alloc[i] < 0:
                                incre_cnt_dsp(1, dsp_alloc[i], res_cat['col3'][ind])
                            else:
                            ...
                            if res_cat['col3'][ind] > 2:
                                ...
                                ncnt_reg2_3[1, phase_region2(r_in_r200_62[i], delv62)] += 1
                                ncnt2_62_3[1, phase_region2(r_in_r200_62[i], delv62)] += 1
                            else:
                                ncnt_reg_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                                ncnt_62_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                        ...
                        ncnt_reg2[1, phase_region2(r_in_r200[i], delv)] += 1
                        ncnt_this2[1, phase_region2(r_in_r200[i], delv)] += 1
                        if res_cat['col3'][ind] > 2:
                            ncnt_reg_3[1, phase_region(r_in_r200[i], delv)] += 1
                            ncnt_this_3[1, phase_region(r_in_r200[i], delv)] += 1

                            ncnt_reg2_3[1, phase_region2(r_in_r200[i], delv)] += 1
                            ncnt_this2_3[1, phase_region2(r_in_r200[i], delv)] += 1
                        else:
                            ncnt_reg_3[0, phase_region(r_in_r200[i], delv)] += 1
                            ncnt_this_3[0, phase_region(r_in_r200[i], delv)] += 1
                    ...
                    if k == 3:
                        if (r_cat[i] == 2):
                            ...
                            ncnt_reg2[2, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ncnt2_58[2, phase_region2(r_in_r200_58[i], delv58)] += 1
                            ...
                            if res_cat['col3'][ind] > 2:
                                ...
                                ncnt_reg2_3[2, phase_region2(r_in_r200_58[i], delv58)] += 1
                                ncnt2_58_3[2, phase_region2(r_in_r200_58[i], delv58)] += 1
                            else:
                                ncnt_reg_3[0, phase_region(r_in_r200_58[i], delv58)] += 1
                                ncnt_58_3[0, phase_region(r_in_r200_58[i], delv58)] += 1
                            ...
                            ncnt_reg2[2, phase_region2(r_in_r200_62[i], delv62)] += 1
                            ncnt2_62[2, phase_region2(r_in_r200_62[i], delv62)] += 1
                            if dsp_alloc[i] < 0:
                                incre_cnt_dsp(2, dsp_alloc[i], res_cat['col3'][ind])
                            else:
                            ...
                            if res_cat['col3'][ind] > 2:
                                ...
                                ncnt_reg2_3[2, phase_region2(r_in_r200_62[i], delv62)] += 1
                                ncnt2_62_3[2, phase_region2(r_in_r200_62[i], delv62)] += 1
                            else:
                                ncnt_reg_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                                ncnt_62_3[0, phase_region(r_in_r200_62[i], delv62)] += 1
                        ...
                        ncnt_reg2[2, phase_region2(r_in_r200[i], delv)] += 1
                        ncnt_this2[2, phase_region2(r_in_r200[i], delv)] += 1
                        if res_cat['col3'][ind] > 2:
                            ncnt_reg_3[2, phase_region(r_in_r200[i], delv)] += 1
                            ncnt_this_3[2, phase_region(r_in_r200[i], delv)] += 1

                            ncnt_reg2_3[2, phase_region2(r_in_r200[i], delv)] += 1
                            ncnt_this2_3[2, phase_region2(r_in_r200[i], delv)] += 1
                        else:
                            ncnt_reg_3[0, phase_region(r_in_r200[i], delv)] += 1
                            ncnt_this_3[0, phase_region(r_in_r200[i], delv)] += 1
    ...
    if k == 3 or k == 6:
        ...
        frac_PM2_58 = np.zeros(8)
        frac_I2_58 = np.zeros(8)
        frac_PM2_62 = np.zeros(8)
        frac_I2_62 = np.zeros(8)
        for i in range(6):
        ...
        for i in range(8):
            print(f'i258:{i}, no:{ncnt2_58[0, i]}, pm:{ncnt2_58[1, i]}, I:{ncnt2_58[2, i]}')
            print(f'i262:{i}, no:{ncnt2_62[0, i]}, pm:{ncnt2_62[1, i]}, I:{ncnt2_62[2, i]}')
            print(f'i258_3:{i}, no:{ncnt2_58_3[0, i]}, pm:{ncnt2_58_3[1, i]}, I:{ncnt2_58_3[2, i]}')
            print(f'i262_3:{i}, no:{ncnt2_62_3[0, i]}, pm:{ncnt2_62_3[1, i]}, I:{ncnt2_62_3[2, i]}')
            frac_PM2_58[i] = ncnt2_58[1, i] / np.sum(ncnt2_58[0:3, i]) * 100
            frac_I2_58[i] = ncnt2_58[2, i] / np.sum(ncnt2_58[0:3, i]) * 100
            frac_PM2_62[i] = ncnt2_62[1, i] / np.sum(ncnt2_62[0:3, i]) * 100
            frac_I2_62[i] = ncnt2_62[2, i] / np.sum(ncnt2_62[0:3, i]) * 100
        print(f'else2: no:{ncnt_else2[0]}, pm:{ncnt_else2[1]}, I:{ncnt_else2[2]}')
        ...
        ax1_in_58_ds.plot(range(8), frac_PM2_58, ls=':', c='orange', label='PM', lw=2)
        ax1_in_58_ds.plot(range(8), frac_I2_58, c='blue', label='M', lw=2)
        ax1_in_58_ds.legend()
        ax1_in_58_ds.set_xticks(range(8))
        ax1_in_58_ds.set_xticklabels(['1', '2', '3', '4', '5', '6', '7', '8'], fontsize=10)
        ax1_in_58_ds.set_ylabel('%', fontsize=10)
        ax1_in_58_ds.tick_params(direction='in')
        ax1_in_58_ds.invert_xaxis()
        ...
        ax1_in_62_ds.plot(range(8), frac_PM2_62, ls=':', c='orange', label='PM', lw=2)
        ax1_in_62_ds.plot(range(8), frac_I2_62, c='blue', label='M', lw=2)
        ax1_in_62_ds.legend()
        ax1_in_62_ds.set_xticks(range(8))
        ax1_in_62_ds.set_xticklabels(['1', '2', '3', '4', '5', '6', '7', '8'], fontsize=10)
        ax1_in_62_ds.set_ylabel('%', fontsize=10)
        ax1_in_62_ds.tick_params(direction='in')
        ax1_in_62_ds.invert_xaxis()
        ...
        frac_PM2_this = np.zeros(8)
        frac_I2_this = np.zeros(8)
        for i in range(6):
        ...
        for i in range(8):
            print(f'i2:{i}, no:{ncnt_this2[0, i]}, pm:{ncnt_this2[1, i]}, I:{ncnt_this2[2, i]}')
            print(f'i2_3:{i}, no:{ncnt_this2_3[0, i]}, pm:{ncnt_this2_3[1, i]}, I:{ncnt_this2_3[2, i]}')
            frac_PM2_this[i] = ncnt_this2[1, i] / np.sum(ncnt_this2[0:3, i]) * 100
            frac_I2_this[i] = ncnt_this2[2, i] / np.sum(ncnt_this2[0:3, i]) * 100
        ...
        ax1_in_ds.plot(range(8), frac_PM2_this, ls=':', c='orange', label='PM', lw=2)
        ax1_in_ds.plot(range(8), frac_I2_this, c='blue', label='M', lw=2)
        ax1_in_ds.legend()
        ax1_in_ds.set_xticks(range(8))
        ax1_in_ds.set_xticklabels(['1', '2', '3', '4', '5', '6', '7', '8'], fontsize=10)
        ax1_in_ds.set_ylabel('%', fontsize=10)
        ax1_in_ds.tick_params(direction='in')
        ax1_in_ds.invert_xaxis()
    ...
    if k == 3:
        ...
        draw_phase_region2(ax1_58_ds, 0.3)
        draw_phase_region2(ax1_62_ds, 0.3)
...
pm_frac_reg = np.zeros(8)
i_frac_reg = np.zeros(8)
pmerr_frac_reg = np.zeros(8)
ierr_frac_reg = np.zeros(8)
pm_frac_reg_3 = np.zeros(8)
i_frac_reg_3 = np.zeros(8)
pmerr_frac_reg_3 = np.zeros(8)
ierr_frac_reg_3 = np.zeros(8)
for i in range(8):
    total_num = ncnt_reg2[0, i] + ncnt_reg2[1, i] + ncnt_reg2[2, i]
    total_num_3 = ncnt_reg2_3[0, i] + ncnt_reg2_3[1, i] + ncnt_reg2_3[2, i]
    print(f'{total_num} {total_num_3}')
    pm_frac_reg[i] = ncnt_reg2[1, i] / total_num * 100
    pm_frac_reg_3[i] = ncnt_reg2_3[1, i] / total_num * 100
    i_frac_reg[i] = ncnt_reg2[2, i] / total_num * 100
    i_frac_reg_3[i] = ncnt_reg2_3[2, i] / total_num * 100
    pmerr_frac_reg[i] = np.sqrt(ncnt_reg2[1, i]) / total_num * 100
    pmerr_frac_reg_3[i] = np.sqrt(ncnt_reg2_3[1, i]) / total_num * 100
    ierr_frac_reg[i] = np.sqrt(ncnt_reg2[2, i]) / total_num * 100
    ierr_frac_reg_3[i] = np.sqrt(ncnt_reg2_3[2, i]) / total_num * 100
axs134.plot(range(8), pm_frac_reg, c='orange', label='Post-merging (2)', lw=5)
axs134.plot(range(8), i_frac_reg, c='blue', label='Merging (2)', lw=5)
axs134.plot(range(8), pm_frac_reg_3, c='orange', ls=':', label='Post-merging (3)', lw=5)
axs134.plot(range(8), i_frac_reg_3, c='blue', ls=':', label='Merging (3)', lw=5)
axs134.fill_between(range(8),
                           [a - b for a, b in zip(pm_frac_reg, pmerr_frac_reg)],
                           [a + b for a, b in zip(pm_frac_reg, pmerr_frac_reg)],
                           alpha=.15, facecolor='orange')
axs134.fill_between(range(8),
...
axs134.set_xticks(range(8))
axs134.set_xticklabels(['1', '2', '3', '4', '5', '6', '7', '8'],
                      fontsize=20)
axs134.set_ylabel('%', fontsize=20)
axs134.tick_params(axis='both', which='major', labelsize=20)
axs134.tick_params(axis='both', which='both', right=True, labelright=False, top=True, labeltop=False)
axs134.tick_params(direction='in')
axs134.legend(fontsize=15)
axs134.invert_xaxis()
fig134.savefig(ab.plot_dir + f'frac_vs_reg2.png')
