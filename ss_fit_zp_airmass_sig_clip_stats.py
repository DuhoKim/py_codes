...
for n in range(0, len(bands)):
    ...
    for m in range(0, len(dates)):
        ...
        if m == 0:
            ...
            ax1.text(0.6, 0.6, r'$' + bands[n] + '\prime$', transform=ax1.transAxes, size=30)
...
fig.savefig(work_dir+'plot/'+'DECam_standardized_vs_trimmed_aper_corr_flag0_{}sigclip_default_2013.png'.format(sig))
